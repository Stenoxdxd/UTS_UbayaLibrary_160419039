...
class BorrowHistoryViewModel(application: Application): AndroidViewModel(application)
{
    ...
    fun refresh() {
        ...
        val url = "https://nmp160419039.000webhostapp.com/ANMP/UTS/show_borrow_histories.php?id=1"
